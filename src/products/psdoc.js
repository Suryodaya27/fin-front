...
<h1 className="text" style={{ color: "white", textAlign: "center"}}>Documents Required</h1><br></br><br></br>
            <p style={{ color: "white", wordSpacing: "4px", marginLeft:"20px"}}> You will need the following documents to get a personal loan through a lending partner of Bajaj Markets:</p>
            <br></br><br></br>
            <center>
              <table>
                  <thead>
